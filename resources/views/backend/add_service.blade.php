...
<div class="">
    <div class="add-room-each w-50">
        <form id="signupForm" enctype="multipart/form-data" method='post' action="{{route('add-services')}}">
            @csrf
            <div class="row">
              <label class="name-add-room-all col-3" for="">Tên dịch vụ:</label>
              <input class="input-add-room col-9" type="text" name="name_service">
            </div>

            <div class="row mt-4">
              <label class="name-add-room-all col-3" for="">Loại dịch vụ:</label>
              <input class="input-add-room col-9" type="text" name="type_service">
            </div>

            <div class="row mt-4">
              <label class="name-add-room-all col-3" for="">Đơn giá:</label>
              <input class="input-add-room col-9" type="text" name="price_service">
            </div>

            <div class="row mt-4">
              <label class="name-add-room-all col-3" for="">Ghi chú:</label>
              <input class="input-add-room col-9" type="text" name="note_service">
            </div>
